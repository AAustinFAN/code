...
datax,datay_train,datay_test = preprocess_across_chiller.readdata(chiller_train=1,chiller_test=0)


print('data size is ', datax.shape, datay_train.shape,datay_test.shape)
...
# trainset = TrainSet(datax[328:805], datay_train[328:805])
# trainset = TrainSet(datax[1454:1792], datay_train[1454:1792])

#chiller2
#2021-五月-27 22:00:00 PM CT  to 2021-六月-18 16:00:00 PM CT
trainset = TrainSet(datax[3528:4050], datay_train[3528:4050])
...
testset = TrainSet(datax[4051:4362], datay_test[4051:4362])
# 2021年6月18日 16:00 PM to 2021年7月1日 16:00 PM

# testset = TrainSet(datax[806:1453],datay_test[806:1453])
# 2021年2月3日 10:00 AM to 2021年3月2日11：00 AM
...
# testset = TrainSet(datax[2772:3353], datay_test[2772:3353])
